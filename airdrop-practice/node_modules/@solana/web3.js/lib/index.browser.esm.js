...
import { coerce, instance, string, tuple, literal, unknown, union, type, optional, any, number as number$1, array, nullable, create, boolean, record, assert as assert$3 } from 'superstruct';
...
class Connection {
  ...
  async getBalanceAndContext(publicKey, commitmentOrConfig) {
    ...
    const res = create(unsafeRes, jsonRpcResultAndContext(number$1()));
  ...
  async getBlockTime(slot) {
    ...
    const res = create(unsafeRes, jsonRpcResult(nullable(number$1())));
  ...
  async getMinimumLedgerSlot() {
    ...
    const res = create(unsafeRes, jsonRpcResult(number$1()));
  ...
  async getFeeForMessage(message, commitment) {
    ...
    const res = create(unsafeRes, jsonRpcResultAndContext(nullable(number$1())));
  ...
  async getBlocks(startSlot, endSlot, commitment) {
    ...
    const res = create(unsafeRes, jsonRpcResult(array(number$1())));
